const Footer = () => {
  return (
    <footer className="bg-v4-surface text-v4-text-muted py-8 border-t border-black/10">
      <div className="max-w-container mx-auto px-4 sm:px-6 text-center text-sm">
        ...
        <p className="mb-4">
          상담문의: <a href="tel:1811-1854" className="font-bold text-v4-text hover:text-v4-gold">1811-1854</a>
        </p>
        <p className="text-xs">
